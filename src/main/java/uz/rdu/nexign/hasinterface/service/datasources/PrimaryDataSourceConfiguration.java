...
@EnableJpaRepositories(
        ...
        basePackages = {"uz.rdu.nexign.hasinterface.repository.mainDS"})
public class PrimaryDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(
        ...
        primaryJpaProperties.put("hibernate.dialect", "org.hibernate.dialect.Oracle10gDialect");
        primaryJpaProperties.put("hibernate.hbm2ddl.auto", "update");
        return primaryEntityManagerFactoryBuilder
                .dataSource(primaryDataSource)
                .packages("uz.rdu.nexign.hasinterface.model.DAO.mainDS.cOne")
